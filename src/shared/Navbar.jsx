            ...
            <div className="navbar bg-bottle-green shadow-sm">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul
                            tabIndex="-1"
                            className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow text-black font-bold">
                            <li>
                            ...
                            <li>
                                ...
                                <ul className="p-2">
                                    ...
                                    <li>
                                        <NavLink to="/ansar" reloadDocument>আনসার</NavLink>
                                    </li>
                                </ul>
                            </li>
                            <li>
                   ...
                   <div>
                     <a className="btn btn-ghost font-bold text-white text-xs">ভোটকেন্দ্র ব্যবস্থাপনা</a>
                   </div>
                </div>
                    ...
                    <li>
                        ...
                        <ul className="p-2 bg-base-100 w-40 z-1 text-black">
                            ...
                            <li>
                             ...
                             <li>
                                <NavLink to="/ansar">আনসার</NavLink>
                            </li>
                        </ul>
                        </details>
                    </li>
