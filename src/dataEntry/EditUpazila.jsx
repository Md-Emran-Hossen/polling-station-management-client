...
const EditUpazila = () => {
    ...
    const handleEdit = (event) => {
        ...
        fetch(`https://polling-station-management-server.vercel.app/upazila/${loadedData._id}`, {
            method: "PUT",
            headers: {
            ...
            .then((data) => {
                if (data.modifiedCount) {
                    ...
                    navigate("/dataEntry/loadUpazilas");
                }
            });
    };
    return (
