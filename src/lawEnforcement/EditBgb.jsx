...
const EditBgb = () => {
    ...
    const handleEdit = (event) => {
        ...
        const bgbName = form.get("bgbName");
        ...
        fetch(`https://polling-station-management-server.vercel.app/bgb/${loadedData._id}`, {
            method: "PUT",
            headers: {
                                ...
                                <div className="md:w-1/3">
                                    <input
                                        className="bg-gray-200 appearance-none border-2 border-gray-200 rounded-none w-full py-2 px-4 text-gray-700 
                                            ...
                                            type="text"
                                            name="bgbName"
                                            defaultValue={loadedData.bgbName}
                                    />
                                </div>
                            </div>
