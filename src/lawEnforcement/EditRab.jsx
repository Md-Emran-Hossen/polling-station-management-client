...
const EditRab = () => {
    ...
    const handleEdit = (event) => {
        ...
        const rabName = form.get("rabName");
        ...
        fetch(`https://polling-station-management-server.vercel.app/rab/${loadedData._id}`, {
            method: "PUT",
            headers: {
            ...
            <div className="my-5 mx-2 mt-20">
                <div className="flex justify-center justify-items-center">
                    <h1 className="text-3xl font-bold text-center mb-10">
                        র‍্যাপিড একশন ব্যাটালিয়ন এর তথ্য সংশোধন করুনঃ
                    </h1>
                    &nbsp;&nbsp;&nbsp;
                    <Link to="/">
                        <button
                                                    ...
                                                    <div className="md:w-1/3">
                                                        <input
                                                            className="bg-gray-200 appearance-none border-2 border-gray-200 rounded-none w-full py-2 px-4 text-gray-700 
                                                                ...
                                                                type="text"
                                                                name="rabName"
                                                                defaultValue={loadedData.rabName}
                                                        />
                                                    </div>
                                                </div>
